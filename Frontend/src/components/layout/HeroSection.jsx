...
const HeroSection = () => {
  return (
    <section className="w-full flex flex-col relative">
      ...
      <div className="relative w-full min-h-[460px] h-[60vh] max-h-[600px] flex items-center">
        ...
        <div className="relative z-10 w-full px-4 sm:px-8 md:px-16 py-12 md:py-16 pb-40 md:pb-32">
          <div className="max-w-xl">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold font-heading text-neutral leading-[1.2] md:leading-[1.1] mb-4 md:mb-5">
              Premium Car Rentals in <br className="hidden sm:block" /> Sivasagar
            </h1>
            <p className="text-neutral/90 text-sm sm:text-base md:text-lg mb-8 leading-relaxed max-w-sm sm:max-w-none">
              Reliable, comfortable, and affordable travel solutions for local sightseeing and outstation trips. Available 24/7.
            </p>
            
            <Button variant="primary" className="gap-2 text-sm md:text-base px-6 py-3.5 rounded-xl shadow-lg shadow-secondary/20 hover:shadow-secondary/40">
      ...
      <div className="w-full px-4 md:px-8 -mt-32 sm:-mt-24 md:-mt-16 lg:-mt-20 relative z-20">
        <FeatureBanner />
      </div>
    </section>
  );
